...
use App\Repository\Deleted\DeletedProductsVariationsRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;


#[ORM\Entity(repositoryClass: DeletedProductsVariationsRepository::class)]
#[ORM\Table(name: "deleted_products_variations")]
class DeletedProductsVariations
{
	...
	#[ORM\GeneratedValue]
	#[ORM\Column]
	private ?int $deleted_products_variations_id = null;
	...
	public function getDeletedProductsVariationsId():  ?int
	{
		return $this->deleted_products_variations_id;
	}

	public function setDeletedProductsVariationsId(int $deleted_products_variations_id) : self
	{
		$this->deleted_products_variations_id = $deleted_products_variations_id;
		return $this;
	}
