...
use App\Repository\Erp\ErpSystemsOrdersExportsHistoryRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;


#[ORM\Entity(repositoryClass: ErpSystemsOrdersExportsHistoryRepository::class)]
#[ORM\Table(name: "erp_systems_orders_exports_history")]
class ErpSystemsOrdersExportsHistory
{
	...
	#[ORM\GeneratedValue]
	#[ORM\Column]
	private ?int $erp_system_orders_exports_history_id = null;
	...
	public function getErpSystemOrdersExportsHistoryId():  ?int
	{
		return $this->erp_system_orders_exports_history_id;
	}

	public function setErpSystemOrdersExportsHistoryId(int $erp_system_orders_exports_history_id) : self
	{
		$this->erp_system_orders_exports_history_id = $erp_system_orders_exports_history_id;
		return $this;
	}
