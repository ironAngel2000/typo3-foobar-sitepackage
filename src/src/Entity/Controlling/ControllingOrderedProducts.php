...
use App\Repository\Controlling\ControllingOrderedProductsRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;


#[ORM\Entity(repositoryClass: ControllingOrderedProductsRepository::class)]
#[ORM\Table(name: "controlling_ordered_products")]
class ControllingOrderedProducts
{
	...
	#[ORM\GeneratedValue]
	#[ORM\Column]
	private ?int $controlling_ordered_products_id = null;
	...
	public function getControllingOrderedProductsId():  ?int
	{
		return $this->controlling_ordered_products_id;
	}

	public function setControllingOrderedProductsId(int $controlling_ordered_products_id) : self
	{
		$this->controlling_ordered_products_id = $controlling_ordered_products_id;
		return $this;
	}
