...
use App\Repository\Products\ProductsImagesToProductsImagesAttributesRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;


#[ORM\Entity(repositoryClass: ProductsImagesToProductsImagesAttributesRepository::class)]
#[ORM\Table(name: "products_images_to_products_images_attributes")]
class ProductsImagesToProductsImagesAttributes
{
	...
	#[ORM\GeneratedValue]
	#[ORM\Column]
	private ?int $products_images_to_products_images_attributes_id = null;
	...
	public function getProductsImagesToProductsImagesAttributesId():  ?int
	{
		return $this->products_images_to_products_images_attributes_id;
	}

	public function setProductsImagesToProductsImagesAttributesId(int $products_images_to_products_images_attributes_id) : self
	{
		$this->products_images_to_products_images_attributes_id = $products_images_to_products_images_attributes_id;
		return $this;
	}
