...
use App\Repository\Products\ProductsToProductsAttributesRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;


#[ORM\Entity(repositoryClass: ProductsToProductsAttributesRepository::class)]
#[ORM\Table(name: "products_to_products_attributes")]
class ProductsToProductsAttributes
{
	...
	#[ORM\GeneratedValue]
	#[ORM\Column]
	private ?int $products_to_products_attributes_id = null;
	...
	public function getProductsToProductsAttributesId():  ?int
	{
		return $this->products_to_products_attributes_id;
	}

	public function setProductsToProductsAttributesId(int $products_to_products_attributes_id) : self
	{
		$this->products_to_products_attributes_id = $products_to_products_attributes_id;
		return $this;
	}
