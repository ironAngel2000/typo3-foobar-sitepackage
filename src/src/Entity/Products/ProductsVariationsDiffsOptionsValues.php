...
use App\Repository\Products\ProductsVariationsDiffsOptionsValuesRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;


#[ORM\Entity(repositoryClass: ProductsVariationsDiffsOptionsValuesRepository::class)]
#[ORM\Table(name: "products_variations_diffs_options_values")]
class ProductsVariationsDiffsOptionsValues
{
	...
	private ?string $extern_products_variations_diffs_options_values_id = null;
	...
	public function getExternProductsVariationsDiffsOptionsValuesId():  ?string
	{
		return $this->extern_products_variations_diffs_options_values_id;
	}

	public function setExternProductsVariationsDiffsOptionsValuesId(string $extern_products_variations_diffs_options_values_id) : self
	{
		$this->extern_products_variations_diffs_options_values_id = $extern_products_variations_diffs_options_values_id;
		return $this;
	}
