...
use App\Repository\Shops\ShopsMatchingProductsVariationsDiffsOptionsRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;


#[ORM\Entity(repositoryClass: ShopsMatchingProductsVariationsDiffsOptionsRepository::class)]
#[ORM\Table(name: "shops_matching_products_variations_diffs_options")]
class ShopsMatchingProductsVariationsDiffsOptions
{
	...
	#[ORM\GeneratedValue]
	#[ORM\Column]
	private ?int $shops_matching_products_variations_diffs_options_id = null;
	...
	public function getShopsMatchingProductsVariationsDiffsOptionsId():  ?int
	{
		return $this->shops_matching_products_variations_diffs_options_id;
	}

	public function setShopsMatchingProductsVariationsDiffsOptionsId(int $shops_matching_products_variations_diffs_options_id) : self
	{
		$this->shops_matching_products_variations_diffs_options_id = $shops_matching_products_variations_diffs_options_id;
		return $this;
	}
