...
use App\Repository\Shops\ShopsProductsVariationsDiffsOptionsValuesRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;


#[ORM\Entity(repositoryClass: ShopsProductsVariationsDiffsOptionsValuesRepository::class)]
#[ORM\Table(name: "shops_products_variations_diffs_options_values")]
class ShopsProductsVariationsDiffsOptionsValues
{
	...
	#[ORM\GeneratedValue]
	#[ORM\Column]
	private ?int $shops_products_variations_diffs_options_values = null;
	...
	public function getShopsProductsVariationsDiffsOptionsValues():  ?int
	{
		return $this->shops_products_variations_diffs_options_values;
	}

	public function setShopsProductsVariationsDiffsOptionsValues(int $shops_products_variations_diffs_options_values) : self
	{
		$this->shops_products_variations_diffs_options_values = $shops_products_variations_diffs_options_values;
		return $this;
	}
