...
use App\Repository\Shops\ShopsProductsAttributesRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;


#[ORM\Entity(repositoryClass: ShopsProductsAttributesRepository::class)]
#[ORM\Table(name: "shops_products_attributes")]
class ShopsProductsAttributes
{
	...
	#[ORM\GeneratedValue]
	#[ORM\Column]
	private ?int $shops_products_attributes_id = null;
	...
	public function getShopsProductsAttributesId():  ?int
	{
		return $this->shops_products_attributes_id;
	}

	public function setShopsProductsAttributesId(int $shops_products_attributes_id) : self
	{
