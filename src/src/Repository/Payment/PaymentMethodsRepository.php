...
use App\Entity\Payment\PaymentMethods;
...
//    /**
//     * @return PaymentMethodsAssignmentTypes[] Returns an array of PaymentMethodsAssignmentTypes objects
//     */
...
//    public function findOneBySomeField($value): ?PaymentMethodsAssignmentTypes
//    {
//        return $this->createQueryBuilder('p')
//            ->andWhere('p.exampleField = :val')
//            ->setParameter('val', $value)
