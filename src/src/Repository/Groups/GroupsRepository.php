...
//    /**
//     * @return GroupsAssignmentTypes[] Returns an array of GroupsAssignmentTypes objects
//     */
...
//    public function findOneBySomeField($value): ?GroupsAssignmentTypes
//    {
//        return $this->createQueryBuilder('p')
//            ->andWhere('p.exampleField = :val')
//            ->setParameter('val', $value)
