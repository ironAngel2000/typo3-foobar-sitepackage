...
use App\Entity\Mailings\Mailings;
use Doctrine\Bundle\DoctrineBundle\Repository\ServiceEntityRepository;
use Doctrine\Persistence\ManagerRegistry;

/**
 * @extends ServiceEntityRepository<Mailings>
 *
...
class MailingsRepository extends ServiceEntityRepository
{
    ...
    public function save(Mailings $entity, bool $flush = false): void
    {
    ...
    public function remove(Mailings $entity, bool $flush = false): void
    {
...
//    /**
//     * @return MailingsAssignmentTypes[] Returns an array of MailingsAssignmentTypes objects
//     */
...
//    public function findOneBySomeField($value): ?MailingsAssignmentTypes
//    {
//        return $this->createQueryBuilder('p')
//            ->andWhere('p.exampleField = :val')
//            ->setParameter('val', $value)
